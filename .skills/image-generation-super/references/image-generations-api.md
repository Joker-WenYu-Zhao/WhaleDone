...
| Endpoint | `POST https://app-dzw9lby2igw1-api-wLNdpny6ZpVa-gateway.appmiaoda.com/image2` |
...
async function createImage(params: CreateImageParams): Promise<CreateImageResult> {
  const response = await fetch(
    "https://app-dzw9lby2igw1-api-wLNdpny6ZpVa-gateway.appmiaoda.com/image2",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
