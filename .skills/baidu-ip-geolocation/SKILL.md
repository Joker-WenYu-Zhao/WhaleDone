...
- **Endpoint**：`GET https://app-dzw9lby2igw1-api-79jK62Ze2pQL-gateway.appmiaoda.com/location/ip`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = `https://app-dzw9lby2igw1-api-79jK62Ze2pQL-gateway.appmiaoda.com/location/ip${
