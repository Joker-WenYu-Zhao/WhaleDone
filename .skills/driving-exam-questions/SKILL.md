...
- **Endpoint**: `POST https://app-dzw9lby2igw1-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-dzw9lby2igw1-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query?${params.toString()}`,
    {
      method: "POST",
      headers: {
