...
- **Endpoint**：`POST https://app-dzw9lby2igw1-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL("https://app-dzw9lby2igw1-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
