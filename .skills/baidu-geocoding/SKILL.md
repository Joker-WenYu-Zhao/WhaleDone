...
|------|------|----------|--------|
| 地理编码 | 地址 → 坐标 | `GET https://app-dzw9lby2igw1-api-GaDwZ0j3erOY-gateway.appmiaoda.com/geocoding/v3/` | GET |
| 逆地理编码 | 坐标 → 地址 | `GET https://app-dzw9lby2igw1-api-baBwZEjbe1X9-gateway.appmiaoda.com/reverse_geocoding/v3` | GET |
