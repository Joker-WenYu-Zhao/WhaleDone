...
| Endpoint | `POST http://app-dzw9lby2igw1-api-rY7JzDpZVBQL-gateway.appmiaoda.com/v1/images/edits` |
...
async function editImage(params: EditImageParams): Promise<EditImageResult> {
  ...
  const response = await fetch(
    "http://app-dzw9lby2igw1-api-rY7JzDpZVBQL-gateway.appmiaoda.com/v1/images/edits",
    {
      method: "POST",
      headers: {
