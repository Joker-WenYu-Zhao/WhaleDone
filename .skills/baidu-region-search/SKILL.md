...
| 属性 | 值 |
|------|---|
| Endpoint | `GET https://app-dzw9lby2igw1-api-DYJwn2VZXvEa-gateway.appmiaoda.com/api_region_search/v1/` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-dzw9lby2igw1-api-DYJwn2VZXvEa-gateway.appmiaoda.com/api_region_search/v1/?${params.toString()}`,
    {
      method: "GET",
      headers: {
