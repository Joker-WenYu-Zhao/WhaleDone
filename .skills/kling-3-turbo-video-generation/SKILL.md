...
- 文生创建任务：`POST https://app-dzw9lby2igw1-api-zYm4DV8yrj8L-gateway.appmiaoda.com/text-to-video/kling-3.0-turbo`
- 图生创建任务：`POST https://app-dzw9lby2igw1-api-eLMlzO5Veyw9-gateway.appmiaoda.com/image-to-video/kling-3.0-turbo`
- 统一查询任务：`GET https://app-dzw9lby2igw1-api-baBwmdOB6lG9-gateway.appmiaoda.com/tasks`
...
async function queryTurboVideoTask(
  ...
  const response = await fetch(
    `https://app-dzw9lby2igw1-api-baBwmdOB6lG9-gateway.appmiaoda.com/tasks?${query}`,
    {
      method: "GET",
      headers: {
...
const createResp = await fetch(
  "https://app-dzw9lby2igw1-api-zYm4DV8yrj8L-gateway.appmiaoda.com/text-to-video/kling-3.0-turbo",
  {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
```typescript
const createResp = await fetch(
  "https://app-dzw9lby2igw1-api-eLMlzO5Veyw9-gateway.appmiaoda.com/image-to-video/kling-3.0-turbo",
  {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
