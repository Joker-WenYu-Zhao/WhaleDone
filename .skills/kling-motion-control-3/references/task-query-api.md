...
```http
GET https://app-dzw9lby2igw1-api-Aa2P8o0BV1RL-gateway.appmiaoda.com/tasks?task_ids=TASK_ID
GET https://app-dzw9lby2igw1-api-Aa2P8o0BV1RL-gateway.appmiaoda.com/tasks?external_task_ids=EXTERNAL_ID
```
